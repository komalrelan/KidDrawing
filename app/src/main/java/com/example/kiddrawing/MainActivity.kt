...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val brush_btn :ImageButton=findViewById(R.id.brush)
        brush_btn.setOnClickListener { showBrushSizeChooserDialog() }
        val ic_gallery :ImageButton = findViewById(R.id.gallery_btn)
        ic_gallery.setOnClickListener {
            requestStoragePermission()

        }
        val btn_undo :ImageButton = findViewById(R.id.undo_btn)
    ...
    private fun showBrushSizeChooserDialog() {
        ...
        val smallBtn: ImageButton = brushDialog.findViewById(R.id.small_img_btn)
        smallBtn.setOnClickListener(View.OnClickListener {
            drawingView?.setSizeForBrush(10.toFloat())
            brushDialog.dismiss()
        })
        val mediumBtn: ImageButton = brushDialog.findViewById(R.id.medium_img_btn)
        mediumBtn.setOnClickListener(View.OnClickListener {
            drawingView?.setSizeForBrush(20.toFloat())
            brushDialog.dismiss()
        })

        val largeBtn: ImageButton = brushDialog.findViewById(R.id.large_img_btn)
                ...
                try {
                    ...
                    val f = File(
                        externalCacheDir?.absoluteFile.toString()
                                + File.separator + "Kiddrawing_" + System.currentTimeMillis() / 1000 + ".jpg"
                    )
